...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/styles.css */ \"./src/styles/styles.css\");\n/* harmony import */ var _citiesWeather__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./citiesWeather */ \"./src/citiesWeather.js\");\n/* harmony import */ var _conversion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./conversion */ \"./src/conversion.js\");\n/* harmony import */ var _giphyGifs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./giphyGifs */ \"./src/giphyGifs.js\");\n\n\n\n\n\nconst cityName = document.getElementById('cityName');\nconst temperature = document.getElementById('temperature');\nconst humidity = document.getElementById('humidity');\nconst wind = document.getElementById('wind-speed');\nconst desc = document.getElementById('desc');\nconst icon = document.getElementById('icon');\n\nconst search = document.getElementById('searchButton');\nconst input = document.getElementById('search');\nconst gif = document.getElementById('gif');\nconst check = document.getElementById('check');\nconst sign = document.getElementById('unit');\n\n\nconst inputS = document.getElementById('search');\n\n\nfunction update(name) {\n    check.checked = false;\n\n    if (check.checked == true) {\n        sign.textContent = '°F';\n    }\n    else\n    {\n        sign.textContent = '°C';\n    }\n\n    (0,_citiesWeather__WEBPACK_IMPORTED_MODULE_1__.getData)(name)\n    .then(val => {\n        cityName.textContent = val.cityW;\n        temperature.textContent = val.temp;\n        humidity.textContent = val.humidity;\n        wind.textContent = val.windSpeed;\n        desc.textContent = val.desc;\n        icon.src = `https://openweathermap.org/img/wn/${val.icon}@2x.png`;\n    })\n    \n    ;(0,_giphyGifs__WEBPACK_IMPORTED_MODULE_3__.genGifs)(`ghibli+totoro+${desc.textContent}`).then(val => {\n            gif.src = val;\n    });\n}\nsearch.addEventListener('click', () => {\n    // update(`${input.textContent}`);\n    console.log(input.value);\n    update(input.value);\n})\n\ninputS.addEventListener('search', () => {\n    console.log(input.value);\n    update(input.value);\n});\n\ncheck.addEventListener('change', () => {\n    (0,_conversion__WEBPACK_IMPORTED_MODULE_2__.convert)();\n})\n\nupdate();\n\n//# sourceURL=webpack://weather-app/./src/index.js?");
